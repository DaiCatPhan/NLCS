                                ...
                                <div class="card-body p-md-5">
                                    <div class="row justify-content-center">
                                        <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                            ...
                                            <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 ">Edit Sinh Viên</p>
                                            ...
                                            <form class="mx-1 mx-md-4 " method="POST" action="../apps/resoures/view/authentication/submit_register.php">
                                                ...
                                                <div class="d-flex flex-row align-items-center mb-4">
                                                    ...
                                                    <div class="form-outline flex-fill mb-0">
                                                        <label class="form-label" for="pass"><b>MSSV</b></label>
                                                ...
                                                <div class="d-flex flex-row align-items-center mb-4">
                                                    <i class="fa-solid fa-lock fa-spin fa-xl me-3 mt-3" style="color: #e70d0d;"></i>
                                                    <div class="form-outline flex-fill mb-0">
                                                        <label class="form-label" for="pass"><b>Lớp</b></label>
                                                        <input type="password" id="pass" class="form-control" name="pass" required />
                                                    </div>
                                                </div>
